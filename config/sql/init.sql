...
(
    ...
    `avatar`           varchar(255) default ''                                                      not null comment 'url',
    `background_image` varchar(255) default ''                                                      not null comment 'url',
    `signature`        varchar(255) default 'NULL'                                                  not null comment '255charmax',
